...
class PdfReportHelper {
  static Future<void> generateAndDownloadReport({
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    ...
                    children: ['Name', 'Email', 'Phone', 'Role']
                        .map(
                          (c) => pw.Padding(
                            padding: const pw.EdgeInsets.all(7),
                            child: pw.Text(
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    ...
                    children: ['Room Name', 'Owner', 'Price/mo', 'Status']
                        .map(
                          (c) => pw.Padding(
                            padding: const pw.EdgeInsets.all(7),
                            child: pw.Text(
            ...
            build: (ctx) => [
              ...
              pw.Table(
                ...
                children: [
                  ...
                  ...rooms.map((r) {
                    PdfColor sc = r.roomStatus == 'occupied'
                        ? PdfColors.orange700
                        : r.roomStatus == 'pending_deletion'
                        ? PdfColors.red700
                        : PdfColors.green700;
                    return pw.TableRow(
                      children: [
              ...
              // 4. Bookings
              pw.Text(
                '4. Bookings  (${bookings.length} total)',
                style: pw.TextStyle(
                  fontSize: 13,
                  fontWeight: pw.FontWeight.bold,
                  color: PdfColors.indigo700,
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    ...
                    children:
                        ['Tenant', 'Room', 'Move-in', 'Move-out', 'Status']
                            .map(
                              (c) => pw.Padding(
                                padding: const pw.EdgeInsets.all(7),
                                child: pw.Text(
                  ...
                  ...bookings.map((b) {
                    PdfColor sc = b.bookingStatus == 'confirmed'
                        ? PdfColors.green700
    ...
    await Printing.layoutPdf(
      ...
      name:
          'rental_room_${reportName}_report_${DateTime.now().millisecondsSinceEpoch}',
    );
  }

  static pw.TableRow _kpiRow(
    String label,
    String value, {
    PdfColor? valueColor,
  }) => pw.TableRow(
